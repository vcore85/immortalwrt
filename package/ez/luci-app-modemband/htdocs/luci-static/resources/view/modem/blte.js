    ...
    load: function () {
        ...
        return L.resolveDefault(fs.exec_direct('/usr/bin/modemband.sh'), 'null').then(L.bind(function (html) {
                if (html == null) {
                    ...
                    this.default = E([E('div', {
                                    'class': 'cbi-value'
                                }, [E('label', {
                                            'class': 'cbi-value-title'
                                        }, _('Bands configuration')), E('div', {
...
var cbiRichListValue = form.ListValue.extend({
    ...
    value: function (value, title, description) {
        if (description) {
            form.ListValue.prototype.value.call(this, value, E([], [E('span', {
                            'class': 'hide-open'
                        }, [title]), E('div', {
                            'class': 'hide-close',
                            'style': 'min-width:25vw'
                        }, [E('strong', [title]), E('br'), E('span', {
...
function handleAction(ev) {
    ...
    if (ev === 'rebootdev') {
        if (confirm(_('Do you really want to restart the device?'))) {
            L.ui.showModal(_('Rebooting…'), [E('p', {
                        'class': 'spinning'
...
return view.extend({
    ...
    render: function (data) {
        ...
        s.render = L.bind(function (view, section_id) {
            return E('div', {
                'class': 'cbi-section'
            }, [E('h3', _('Modem information')), E('table', {
                        'class': 'table'
                    }, [E('tr', {
                                'class': 'tr'
                            }, [E('td', {
                                        'class': 'td left',
                                        'width': '33%'
                                    }, [_('Currently set LTE bands')]), E('td', {
                                        'class': 'td left',
                                        'id': 'modemlteb'
                                    }, [modemen || '-']), ]), E('tr', {
                                'class': 'tr'
        ...
        if (json.enabled == '' || json.modem == '' || json.modem === undefined || json.enabled === undefined) {
            ...
            o = s.taboption('bandset', cbiRichListValue, 'set_bands', _('Modification of the bands'), _("Select the preferred band(s) for the modem."));
            for (var i = 0; i < json.supported.length; i++) {
            ...
            o.default = '<div class="cbi-section-descr">' +
                _('Hint: The name of the WAN section can be changed in the package settings panel.') + '</div>';
            ...
            o.rawhtml = true;
            o.default = '<div class="cbi-section-descr">' +
                _('Hint: Option dedicated to the ZTE MF286D router.') + '</div>';
            if (modem.includes('MF286D')) {
                ...
                o.default = '<div class="cbi-value-field"><em>' +
                    _('No supported modem / router was found...') + '</em></div>';
            };
        }
        return m.render();
    },
