...
return view.extend({
    ...
    render: function (data) {
                ...
                'class': 'cbi-section'
                        ...
                        'class': 'table'
                                ...
                                'class': 'tr'
                                        ...
                                        'class': 'td left',
                                        'width': '33%'
                                    }, [_('Currently set 5G SA bands')]), E('td', {
                                        'class': 'td left',
                                        'id': 'modemlteb'
                                    }, [modemen || '-']), ]), E('tr', {
                                'class': 'tr'
        ...
        if (json.supported5gsa === undefined && json.enabled5gsa === undefined) {
            ...
            o = s.taboption('bandset', cbiRichListValue, 'set_5gsabands', _('Modification of the bands'), _("Select the preferred band(s) for the modem."));
            for (var i = 0; i < json.supported5gsa.length; i++) {
