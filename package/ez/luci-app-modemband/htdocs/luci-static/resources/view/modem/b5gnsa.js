...
return view.extend({
    ...
    render: function (data) {
                ...
                'class': 'cbi-section'
                        ...
                        'class': 'table'
                                ...
                                'class': 'tr'
                                        ...
                                        'class': 'td left',
                                        'width': '33%'
                                    }, [_('Currently set 5G NSA bands')]), E('td', {
                                        'class': 'td left',
                                        'id': 'modemlteb'
                                    }, [modemen || '-']), ]), E('tr', {
                                'class': 'tr'
        ...
        if (json.supported5gnsa === undefined && json.enabled5gnsa === undefined) {
            ...
            o = s.taboption('bandset', cbiRichListValue, 'set_5gnsabands', _('Modification of the bands'), _("Select the preferred band(s) for the modem."));
            for (var i = 0; i < json.supported5gnsa.length; i++) {
