			...
			pollData: poll.add(function() {
				return L.resolveDefault(fs.exec_direct('/usr/share/3ginfo-lite/3ginfo.sh', 'json'))
					...
					if (document.getElementById('operator')) {
						...
						var operatorName = json.operator_name;
						if (operatorName == '46015') {
							view.textContent = "中国广电";
						} else if (['46001', '46009', '46010'].includes(operatorName)) {
							view.textContent = "中国联通";
						} else if (['46003', '46011', '46012'].includes(operatorName)) {
							view.textContent = "中国电信";
						} else if (['46002', '46004', '46007', '46000', '46008'].includes(operatorName)) {
							view.textContent = "中国移动";
						} else {
							view.textContent = "其他运营商";
						}
						}
						}
					}
